...
//        this.printArea = printArea;
    ...
    public void redoCellSample( int gridLocX, int gridLocY )
    {
        ...
        for( int i = 0; i < samples.size(); i++ )
        {
            ...
            {
                // Points are equal to each other, so remove the sample set from
                // the array list
                ...
                for( int k = 0; k < numSamples; k++ )
                {
                    ...
                    // Set the output of the WiFi scanner to the new sample for
                    // this cell.
                    newSample.setScan( wifiScanner.scan() );
    ...
    public void finishSampling( String locDesc, String fileComment )
    {
        ...
        sampleFile = new AndroidLog( sampleFileName );
...
//                printArea.append( "\n" );
    ...
    private WiFiDemo wifiScanner; // The generic WiFi scanner used for
                                     // generating a sample list of access
                                     // points with RSSID values.

    private ArrayList<CellSample> samples; // The list of cells that are being
                                           // sampled.

    /* Not needed for Android. Can be handled through WifiDemo (working title) */
//    private JTextArea printArea; // The console window where debug information
                                 // can be print to.
    ...
    private String sampleFileName; //will be in wifidemo
