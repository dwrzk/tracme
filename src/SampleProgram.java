...
public class SampleProgram
{
    ...
    public void finishSampling( String locDesc, String fileComment )
    {
        ...
        sampleFileExt
                .writeToFile( "//-------------------------------------------------------------------------------\n" );
        sampleFileExt.writeToFile( "// Sample File Name:        "
                + sampleFileName + "\n" );
    ...
    private WriteFile sampleFile; // The raw data file that holds all of the
                                  // generated samples for the current data
                                  // set.
    private WriteFile sampleFileExt; // The extended data file with more
